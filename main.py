...
#def save(counter,track_scores):
#	if counter in [1,10,20,30,40]:
#		# save the scores
#		with open('track_scores_detective_pop10gen100counter25_210718.pkl', 'wb') as f:
...
def train_agent(game_chosen):
	...
	# save the scores
	with open('track_scores_zork_pop100gen500_300718.pkl', 'wb') as f:
		pickle.dump(track_scores, f)

	# save the final weights
	with open('final_weights_zork_pop100gen500_300718.pkl', 'wb') as g:
